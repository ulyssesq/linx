...
namespace Algorithm.Logic.Tests
{
    ...
    public class DroneUnitTest
    {
        ...
        [TestMethod]
        public void Input_BIGNUMBER()
        {
            Assert.AreEqual("(999, 999)", Program.Evaluate("N2147483648")); // Número maior que o permitido
        }

        [TestMethod]
        public void Input_STARTINGX()
        {
            // Se inicia com X ignoro o X, mas não invalida a entrada
            // a especificação não trata deste caso.
            // Considero que é possível processar este caso, então assim o faço.
            Assert.AreEqual("(0, 1)", Program.Evaluate("XXN")); 
        }
    }
}
